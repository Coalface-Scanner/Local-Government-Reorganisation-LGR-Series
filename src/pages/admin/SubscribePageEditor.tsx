...
export default function SubscribePageEditor() {
  ...
  const handleUpdate = async (sectionKey: string) => {
    ...
    if (!error) {
      ...
      alert('Error updating subscribe page content: ' + error.message);
    }
  };
  ...
  if (loading) {
    return <div className="text-slate-600">Loading subscribe page content...</div>;
  }
  ...
  const sections = [
    ...
    { key: 'card_new_articles_title', label: 'New Articles Card Title', type: 'text' },
    { key: 'card_new_articles_description', label: 'New Articles Card Description', type: 'textarea' },
    { key: 'card_extended_notes_title', label: 'Extended Notes Card Title', type: 'text' },
    { key: 'card_extended_notes_description', label: 'Extended Notes Card Description', type: 'textarea' },
    { key: 'card_playbook_title', label: 'Playbook Card Title', type: 'text' },
    { key: 'card_playbook_description', label: 'Playbook Card Description', type: 'textarea' },
  ];

  return (
    <div className="space-y-6">
      <h2 className="text-3xl font-bold text-slate-900">Subscribe Page Content</h2>
