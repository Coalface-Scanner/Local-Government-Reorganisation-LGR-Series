...
export const staticRoutes: SitemapUrl[] = [
  ...
  { loc: '/about/partnership', changefreq: 'monthly', priority: 0.7 },
  { loc: '/about/contributors/contribute', changefreq: 'monthly', priority: 0.6 },
  ...
  { loc: '/reasons', changefreq: 'monthly', priority: 0.7 },
  { loc: '/lgr-hub', changefreq: 'monthly', priority: 0.8 },
  { loc: '/surrey/area-profile', changefreq: 'weekly', priority: 0.8 },
  ...
  { loc: '/surrey/lessons', changefreq: 'weekly', priority: 0.7 },
